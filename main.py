...
if __name__ == "__main__":
    ...
    if args.driver_type == "firefox":
        ...
        # We will be using cookies from the non-selenium Google Chrome and have login inside that already
        options.add_argument(
            "user-data-dir=C:\\Users\\ptanm\\AppData\\Local\\Google\\Chrome\\User Data")
        if args.headless:
            options.add_argument("headless")
        if args.webdriver_path != None:
            executable_path = args.webdriver_path
