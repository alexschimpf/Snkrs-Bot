        ...
        try:
            ...
            try:
                ...
                select_shoe_size(driver=driver, shoe_size=shoe_size,
                                 shoe_type=shoe_type, skip_size_selection=skip_size_selection)
            except Exception as e:
            ...
            if skip_add_address is False and shipping_address:
                ...
                try:
                    input_address(
                        driver=driver, shipping_address=shipping_address)
                except Exception as e:
            ...
            if skip_select_shipping is False:
                try:
                    ...
                    LOGGER.exception(
                        "Failed to select shipping option: " + str(e))
                    six.reraise(Exception, e, sys.exc_info()[2])
...
def select_shipping_option(driver, shipping_option):
    ...
    if shipping_option != "STANDARD":
        element = wait_until_present(
            driver, el_id=shipping_option, duration=10)
        driver.execute_script("arguments[0].click();", element)
...
def poll_checkout_phase_one(driver):
    ...
    while True:
        ...
        try:
            ...
            LOGGER.exception(
                "Failed visibility check for Shipping options: " + str(e))
        ...
        try:
            ...
            LOGGER.exception(
                "Failed visibility check for Submit Button: " + str(e))
...
def poll_checkout_phase_two(driver):
    ...
    while True:
        ...
        try:
            ...
            LOGGER.exception(
                "Failed visibility check #2 for Payment: " + str(e))
        ...
        try:
            ...
            LOGGER.exception(
                "Failed visibility check #2 for Submit Button: " + str(e))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--shipping-option", default="STANDARD",
    ...
    if shoe_size is None and shoe_type in ("Y", "C", "W"):
        raise Exception(
            "Shoe size parameter must be passed in with your shoe type " + shoe_type + ".")
